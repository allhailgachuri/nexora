...
exports.Tier1RuleEngine = void 0;
class Tier1RuleEngine {
    /**
     * Fast microsecond inline checks on incoming telemetry reading
     */
    static evaluate(currentValues, currentTimestamp, schema, recentHistory) {
        const violations = [];
        const boundsExceeded = [];
        const rateOfChangeExceeded = [];
...
exports.Tier1RuleEngine = Tier1RuleEngine;
